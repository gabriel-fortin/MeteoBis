 ...
 */
public class ParamsMergerTest {
    public static final String TAG = ParamsMergerTest.class.getSimpleName();
...
//
//        ParamsMerger confUmService
//                = new ParamsMerger(umMeteogramService, time, locationParams, interval);
//
...
//        Log.d(TAG, "subscribed: " + subscription.isUnsubscribed());
    ...
    @Inject
    ParamsMerger injected_confUmService;
